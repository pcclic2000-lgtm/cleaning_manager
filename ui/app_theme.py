...
from PyQt6.QtWidgets import QLineEdit, QTextEdit, QComboBox, QSpinBox, QDoubleSpinBox
from PyQt6.QtWidgets import QTabWidget, QLabel, QProgressBar, QScrollArea, QMenu
...
class AppTheme:
    ...
    @staticmethod
    def get_label_style(type: str = "normal") -> str:
        """
        Style pour les labels
        
        Args:
            type: Type de label (normal, title, subtitle, success, error, warning)
        ...
        return styles.get(type, styles["normal"])
    ...
    def apply_global_style(widget):
        ...
        """
        # Appliquer le style à tous les widgets enfants
        for child in widget.findChildren(QWidget):
            if isinstance(child, QPushButton):
                # Déterminer le type de bouton par son texte ou son objetName
        ...
        # Appliquer le style pour les tooltips
